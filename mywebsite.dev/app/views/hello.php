...
<html>
<head>
<title>Karina Montes-Trevino | Home </title>
...
<body>
	<div class="content" id="home">
		...
		<!-- start h_logo -->
				<div class="logo">
							<h1><a href="index.html">Karina Montes</a></h1>
						</div>
				<!-- start h_menu -->
				<div class="h_menu">
			...
			<link href="../web/css/header_style1.css" rel="stylesheet" type="text/css" media="all" />
	...
	<div class="group_2" id="Portfolio">
		...
		<div class="item" >
			<div class="carousel">
		  	    <div class="group_2_img1">
					<img src="web/images/spotspy.png" alt="">
				</div>
		...
		<div class="item">
			<div class="carousel">
		  	   <div class="group_2_img1">
					<img src="web/images/nationalparks.jpg" alt="">
				</div>
				<div class="group_2_text2">
					<div class="desc">
						<h3>client</h3>
		...
		<div class="item">
			<div class="carousel">
		  	    <div class="group_2_img1">
					<img src="web/images/todo-list.jpg" alt="">
				</div>
				<div class="group_2_text2">
					<div class="desc">
						<h3>client</h3>
		...
		<div class="item">
			<div class="carousel">
		  	    <div class="group_2_img1">
					<img src="web/images/FAQ.png" alt="">
				</div>
				<div class="group_2_text2">
					<div class="desc">
						<h3>client</h3>
		...
		<div class="wrap">
			...
			<form>
				...
				<div class="right-form">
					<h4>LOCATION</h4>
					<p>112 E. Pecan St. 10th Floor, San Antonio TX.</p>
					<div class="soc_icons">
					<h4>I AM SOCIAL</h4>
					<ul>
			...
			<div class="contact-map">Geekdom: San Antonio
						<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.co.in/?ie=UTF8&amp;ll=29.428523,-98.491943&amp;spn=3.803105,6.696167&amp;t=m&amp;z=19&amp;output=embed"></iframe>
			</div>
				<div class="footer">
				<div class="wrap">
